...
<body>
				...
				<form class="form-horizontal" id="addform">
					...
					<div class="form-group">
						<button type="button" class="btn btn-success">
							Add Book <i class="glyphicon glyphicon-add"></i>
						</button>
					</div>
				</form>
				<div id="status"></div>
	...
	$(document).ready(function() {
		$("#addform button").click (function() {
			$.ajax({
				method: 'POST',
			    url: 'https://localhost:8080/WebApp/AddBookServlet',
			    ...
			    data: {title: $('#title').val(), author: $('#author').val(), published: $('#published').val()},
